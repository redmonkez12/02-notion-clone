...
export default function Navigation() {
    ...
    return (
        <>
            <aside className="group/sidebar h-full bg-secondary overflow-y-auto relative
            ...
            ">
                ...
                <div className="opacity-0 group-hover/sidebar:opacity-100 transition cursor-ew-resize
